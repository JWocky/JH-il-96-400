...
var gui_dir = getprop("/sim/aircraft-dir") ~ "/Canvas/";
var loadGUIFile = func(file) io.load_nasal(gui_dir ~ file, "canvas2");
...
var style = canvas2.DefaultStyle.new("AmbianceClassic", "Humanity");
var WindowButton = {
  new: func(parent, name)
  {
    var m = {
      parents: [WindowButton, canvas.gui.widgets.Button.new(parent, nil, {"flat": 1})],
      _name: name
    };
...
var Window = {
  ...
  new: func(size, type = nil, id = nil)
  {
    ...
    var m = {
      parents: [Window, canvas.PropertyElement, ghost],
      _ghost: ghost,
...
# canvas2.getDesktop().addEventListener("mousedown", func {
#  if( gui.focused_window != nil )
#    gui.focused_window.clearFocus();
#});
